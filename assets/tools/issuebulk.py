#!/usr/bin/env python3
# Script to issue assets on the ProcyonCoin platform
...
# Prerequisite: procyond daemon to be running
...
#mode =  "-regtest"
#rpc_port = 18443
csv_file = "Procyon Assets - Sheet1.csv"
#Set this information in your procyon.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
