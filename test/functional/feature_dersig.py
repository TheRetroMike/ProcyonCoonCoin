...
class BIP66Test(ProcyonTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # procyond is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and procyond produces more specific reject
            # reasons.
