...
class WalletTest(ProcyonTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 PRCO from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 PRCO with subtract fee from amount
        ...
        # Sendmany 10 PRCO with subtract fee from amount
