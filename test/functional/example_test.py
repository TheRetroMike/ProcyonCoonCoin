...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ProcyonTestFramework
    pass

class ExampleTest(ProcyonTestFramework):
    # Each functional test is a subclass of the ProcyonTestFramework class.
    ...
    def custom_method(self):
        ...
        ProcyonTestFramework class so other tests can use it."""
