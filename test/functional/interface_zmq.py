...
import os
import struct
from test_framework.test_framework import ProcyonTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(ProcyonTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that procyon has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("procyond has not been built with zmq enabled.")
