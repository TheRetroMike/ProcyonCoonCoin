...
class AssetTest(ProcyonTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("PROCYON1", 1000)
        n0.issue("PROCYON2", 1000)
        n0.issue("PROCYON3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="PROCYON*", verbose=False, count=2, start=-2)
        ...
        procyon_assets = n0.listassets(asset="PROCYON*", verbose=False, count=2, start=-2)
        assert_equal(len(procyon_assets), 2)
        assert_equal(procyon_assets[0], "PROCYON2")
        assert_equal(procyon_assets[1], "PROCYON3")
        self.sync_all()
