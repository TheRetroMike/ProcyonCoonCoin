...
By default, procyond will dump mempool on shutdown and
...
class MempoolPersistTest(ProcyonTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give procyond a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent procyond from writing mempool.dat to disk. Verify that `savemempool` fails")
