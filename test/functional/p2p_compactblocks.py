...
# TestNode: A peer we use to send messages to procyond, and store responses.
...
class CompactBlocksTest(ProcyonTestFramework):
    ...
    # This test actually causes procyond to (reasonably!) disconnect us, so do this last.
    ...
    # Test that procyond requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for procyond to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # procyond will not send blocktxn responses for blocks whose height is
