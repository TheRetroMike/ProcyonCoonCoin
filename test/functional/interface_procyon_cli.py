...
class TestProcyonCli(ProcyonTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `procyon-cli getinfo`")
        ...
        self.log.info("Compare responses from `procyon-cli -getinfo` and the RPCs data is retrieved from.")
