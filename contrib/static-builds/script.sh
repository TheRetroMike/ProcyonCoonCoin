...
find ${DISTNAME}/bin -type f -executable -exec ../procyoncoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../procyoncoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/procyoncoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/procyoncoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
