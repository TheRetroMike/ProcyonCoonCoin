...
"""
    ...
    Procyon should be started with the command line arguments:
        procyond -testnet -daemon \
...
print("Getting ProcyonCoin msgs")
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND PRCO issuance at " + str(pos))
				print("After PRCO: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND PRCO something at " + str(pos))
			start += pos+8
			print(astr)
