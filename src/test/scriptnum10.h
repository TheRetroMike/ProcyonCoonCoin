...
#ifndef PROCYON_TEST_SCRIPTNUM10_H
#define PROCYON_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Procyon Core 0.10.0, for cross-comparison.
 */
public:
