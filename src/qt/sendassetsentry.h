...
#ifndef PROCYON_QT_SENDASSETSENTRY_H
#define PROCYON_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending procyons.
...
#endif // PROCYON_QT_SENDASSETSENTRY_H
