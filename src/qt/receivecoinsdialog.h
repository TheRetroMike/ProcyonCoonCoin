...
#ifndef PROCYON_QT_RECEIVECOINSDIALOG_H
#define PROCYON_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of procyons */
...
#endif // PROCYON_QT_RECEIVECOINSDIALOG_H
