...
#ifndef PROCYON_QT_OPTIONSMODEL_H
#define PROCYON_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Procyon client.
...
#endif // PROCYON_QT_OPTIONSMODEL_H
