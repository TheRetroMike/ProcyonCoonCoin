...
void WalletView::setProcyonGUI(ProcyonGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? ProcyonGUI::HD44_ENABLED : _walletModel->hdEnabled() ? ProcyonGUI::HD_ENABLED : ProcyonGUI::HD_DISABLED);
