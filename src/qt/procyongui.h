...
#ifndef PROCYON_QT_PROCYONGUI_H
#define PROCYON_QT_PROCYONGUI_H
...
/**
  Procyon GUI main class. This class represents the main window of the Procyon UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ProcyonGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ProcyonGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ProcyonGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a procyon wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
