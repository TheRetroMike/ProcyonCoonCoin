...
#include "config/procyon-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatProcyonURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + ProcyonUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatProcyonURI(info));
}
