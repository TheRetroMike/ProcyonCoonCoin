...
#ifndef PROCYON_QT_PROCYONAMOUNTFIELD_H
#define PROCYON_QT_PROCYONAMOUNTFIELD_H
...
/** Widget for entering procyon amounts.
  */
class ProcyonAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit ProcyonAmountField(QWidget *parent = 0);
...
#endif // PROCYON_QT_PROCYONAMOUNTFIELD_H
