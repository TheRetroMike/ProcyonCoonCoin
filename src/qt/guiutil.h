...
#ifndef PROCYON_QT_GUIUTIL_H
#define PROCYON_QT_GUIUTIL_H
...
/** Utility functions used by the Procyon Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "procyon:" URI into recipient object, return true on successful parsing
