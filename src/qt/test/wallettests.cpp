...
#include "qt/procyonamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<ProcyonAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_procyon-qt -platform xcb      # Linux
//     src/qt/test/test_procyon-qt -platform windows  # Windows
//     src/qt/test/test_procyon-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = ProcyonUnits::formatWithUnit(unit, balance, false, ProcyonUnits::separatorAlways);
    ...
    // Amount input
    ProcyonAmountField* amountInput = receiveCoinsDialog.findChild<ProcyonAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: procyon:")) != -1);
