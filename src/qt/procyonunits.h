...
#ifndef PROCYON_QT_PROCYONUNITS_H
#define PROCYON_QT_PROCYONUNITS_H
...
/** Procyon unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ProcyonUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ProcyonUnits(QObject *parent);
...
typedef ProcyonUnits::Unit ProcyonUnit;

#endif // PROCYON_QT_PROCYONUNITS_H
