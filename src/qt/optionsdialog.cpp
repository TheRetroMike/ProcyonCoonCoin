    ...
    mapper(0)
{
    ...
    ui->procyonAtStartup->setToolTip(ui->procyonAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->procyonAtStartup->setText(ui->procyonAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openProcyonConfButton->setToolTip(ui->openProcyonConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new ProcyonUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->procyonAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openProcyonConfButton_clicked()
{
