...
#ifndef PROCYON_SCRIPT_STANDARD_H
#define PROCYON_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_PROCYON_ASSET script that carries data
    /** PRCO END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a procyoncoin address
 */
...
/**
 * Generate a Procyon scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // PROCYON_SCRIPT_STANDARD_H
