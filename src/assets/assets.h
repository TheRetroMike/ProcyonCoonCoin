...
#ifndef PROCYONCOIN_ASSET_PROTOCOL_H
#define PROCYONCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_PROCYON_ASSET RVNQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_PROCYON_ASSET RVNO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_PROCYON_ASSET RVNR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_PROCYON_ASSET RVNT
...
#endif //PROCYONCOIN_ASSET_PROTOCOL_H
