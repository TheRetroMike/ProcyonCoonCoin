...
Below are some notes on how to build Procyon Core for Windows.
...
Then build using:
    ...
    CONFIG_SITE=$PWD/depends/x86_64-w64-mingw32/share/config.site ./configure --enable-cxx --disable-shared --with-pic --prefix=/
    make -j4
...
way. This will install to `c:\workspace\procyon`, for example:

    make install DESTDIR=/mnt/c/workspace/procyon
