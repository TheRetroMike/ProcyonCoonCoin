Procyon Core version *2.1.0* is now available!!
==============

  <https://github.com/ProcyonCoin/ProcyonCoonCoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/ProcyonCoin/ProcyonCoonCoin/commits/release_2.1.0>
