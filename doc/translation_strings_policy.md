...
This document provides guidelines for internationalization of the Procyon Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `procyon_en.ts` remains unchanged.
